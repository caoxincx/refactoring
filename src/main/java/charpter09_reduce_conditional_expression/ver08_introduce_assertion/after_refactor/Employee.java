package charpter09_reduce_conditional_expression.ver08_introduce_assertion.after_refactor;
...
public class Employee {
    ...
    double getExpenseLimit() {
        Assert.assertTrue(expenseLimit != NULL_EXPENSE  && Objects.nonNull(primaryProject));
